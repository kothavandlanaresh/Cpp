...
Demonstrates the use of function pointers, typedefs for function pointers, and `std::function` in C++.

## Key Points

1. **Direct Function Pointer**:
   - **Description**: Directly assigns a function to a function pointer and calls it.
   - **Example**:
     ```cpp
...
2. **Typedef Function Pointer**:
   - **Description**: Uses `typedef` to simplify the syntax of function pointers.
   - **Example**:
     ```cpp
...
3. **Using `std::function`**:
   - **Description**: Uses `std::function` to store and call a function.
   - **Example**:
     ```cpp
