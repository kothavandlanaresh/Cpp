...
/**
 * @brief Prints the elements of a raw array.
 * 
 * This function takes a raw array and its size as arguments and prints its elements.
 * 
 * @param arr The raw array to be printed.
 ...
 * 
 * This function takes a constant reference to a std::vector and prints its elements.
 * 
...
/**
 * @brief Demonstrates the use of the at() method for bounds checking.
 * 
 * This function attempts to access elements of a vector using both the at() method and the subscript operator.
 * It shows how at() provides bounds checking and throws an exception if an invalid index is accessed.
 * 
